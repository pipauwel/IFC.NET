...
namespace BuildingSmart.IFC.IfcDateTimeResource
{
		...
		BuildingSmart.IFC.IfcExternalReferenceResource.IfcResourceObjectSelect
	{
		...
		protected IfcTimeSeries(IfcLabel name, IfcDateTime startTime, IfcDateTime endTime, IfcTimeSeriesDataTypeEnum timeSeriesDataType, IfcDataOriginEnum dataOrigin)
		{
			this.Name = name;
