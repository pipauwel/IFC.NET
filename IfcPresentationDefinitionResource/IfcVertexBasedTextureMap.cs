...
namespace BuildingSmart.IFC.IfcPresentationDefinitionResource
{
	...
	public partial class IfcVertexBasedTextureMap
	{
		...
		public IfcVertexBasedTextureMap(IfcTextureVertex[] textureVertices, IfcCartesianPoint[] texturePoints)
		{
			this.TextureVertices = new List<IfcTextureVertex>(textureVertices);
			this.TexturePoints = new List<IfcCartesianPoint>(texturePoints);
		}
