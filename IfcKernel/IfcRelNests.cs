...
namespace BuildingSmart.IFC.IfcKernel
{
	...
	public partial class IfcRelNests : IfcRelDecomposes
	{
		...
		public IfcRelNests(IfcGloballyUniqueId globalId, IfcObjectDefinition relatingObject, IfcObjectDefinition[] relatedObjects)
			: base(globalId)
		{
			this.RelatingObject = relatingObject;
			this.RelatedObjects = new List<IfcObjectDefinition>(relatedObjects);
		}
