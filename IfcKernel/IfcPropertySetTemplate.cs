...
namespace BuildingSmart.IFC.IfcKernel
{
	...
	public partial class IfcPropertySetTemplate : IfcPropertyTemplateDefinition
	{
		...
		public IfcPropertySetTemplate(IfcGloballyUniqueId globalId, IfcPropertyTemplate[] hasPropertyTemplates)
			: base(globalId)
		{
			this.HasPropertyTemplates = new HashSet<IfcPropertyTemplate>(hasPropertyTemplates);
