...
namespace BuildingSmart.IFC.IfcPresentationOrganizationResource
{
	...
	public partial class IfcLightDistributionData
	{
		...
		public IfcLightDistributionData(IfcPlaneAngleMeasure mainPlaneAngle, IfcPlaneAngleMeasure[] secondaryPlaneAngle, IfcLuminousIntensityDistributionMeasure[] luminousIntensity)
		{
			...
			this.SecondaryPlaneAngle = new List<IfcPlaneAngleMeasure>(secondaryPlaneAngle);
			this.LuminousIntensity = new List<IfcLuminousIntensityDistributionMeasure>(luminousIntensity);
		}
