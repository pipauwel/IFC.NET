...
namespace BuildingSmart.IFC.IfcCostResource
{
	...
	public partial class IfcAppliedValueRelationship
	{
		...
		public IfcAppliedValueRelationship(IfcAppliedValue componentOfTotal, IfcAppliedValue[] components, IfcArithmeticOperatorEnum arithmeticOperator)
		{
			this.ComponentOfTotal = componentOfTotal;
			this.Components = new HashSet<IfcAppliedValue>(components);
